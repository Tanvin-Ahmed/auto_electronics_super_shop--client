...
export const PRODUCT_DELETE_FAIL = "product delete fail";
...
export const USER_LIST_FAIL = "user list fail";
...
export const USER_DETAILS_RESET = "user details reset";

//*  update user profile
export const UPDATE_USER_PROFILE_REQUEST = "update user profile request";
...
export const USER_UPDATE_RESET = "user update reset";
...
//* my order list
export const MY_ORDER_LIST_REQUEST = "my order list request";
